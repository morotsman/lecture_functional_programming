describe('fibonacci', function () {
    ...
    it("fibonacci(1) should be 0", function(){
	...
	it("fibonacci(3) should be 1", function(){
        expect(fibonacci(3)).toEqual(1);
    });
	
	it("fibonacci(4) should be 2", function(){
        expect(fibonacci(4)).toEqual(2);
    });
	
	it("fibonacci(7) should be 8", function(){
        expect(fibonacci(7)).toEqual(8);
    });
	
	it("fibonacci(10) should be 34", function(){
